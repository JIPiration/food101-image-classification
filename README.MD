...
###DoingLAB_Dataset 중 알파벳 순으로 상위 50개 클래스 분류
...
멀티 라벨 분류를 학습시키지 안았지만 멀티 클래스 분류가 가능.



# Further Improvements
- 다른 이미지들로도 모델을 통해 제대로 된 분류를 할 수 있을지
- 이 모델에 더 성능을 추가할 수 있는 알고리즘이나 모델링을 향후 적용시켜 정확도를 측정
- 더 많은 Pre-trained 모델을 저장하여 활용.
- 더 최근에 소개된 논문들의 내용을 적용할 부분이 있는지 확인해보고, 모델링을 할 수 있도록 하고자.
